...
SELECT countryLanguage.CountryCode, countryLanguage.language from countrylanguage WHERE percentage > 50;
select country.name from country where country.name like'%ist%';
select country.name from country where not country.code = 'NLD' and not country.code = 'AFG';
select country.name , country.code from country where country.lifeexpectancy > 50 and country.lifeexpectancy < 70;
select city.name,city.population from city  where Countrycode ='NLD';
show tables;